...
class Window(QMainWindow): 
    ...
    def add_task(self):
        ...
        if task != "":
            ...
            msg = QMessageBox()
            msg.setText("You tried to enter a task while the text field was empty.\nType a task and then press the button again.")
    ...
    def delete_task(self):
        try:
            ...
            msg2 = QMessageBox()
            msg2.setText("An error occured while trying to delete a task.")
            msg2.setWindowTitle("Error report")
    ...
    def load_tasks(self):
        try:
            ...
            msg3 = QMessageBox()
            msg3.setText("An error occured while trying to load tasks.")
            msg3.setWindowTitle("Error report")
